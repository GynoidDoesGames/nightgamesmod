...
public class PacifistModifier extends BaseModifier {
    ...
    public String acceptance() {
        ...
        String kickThreat;
        if(player.hasBalls()) {
            kickThreat = "kicks " + player.directObject(true) + " in the balls"; 
        } else if(player.hasDick()) {
            kickThreat = "kicks " + player.directObject(true) + " in the dick"; 
        } else {
            kickThreat = "kicks " + player.directObject(true) + " down";
        }
        return "Lilly flashes you a broad grin and slaps you on the back uncomfortably hard. <i>\"Just so everyone's aware,\"</i> she calls out to your opponents, <i>\""
                        + player.getTrueName() + " has sworn that " + player.pronoun(true) + " won't hurt any girls tonight. So no matter how much anyone taunts " + player.directObject(true)
                        + ", whips " + player.directObject(true) + ", or " + kickThreat + ", " + player.pronoun(true) + " can't retaliate in any way.\""
